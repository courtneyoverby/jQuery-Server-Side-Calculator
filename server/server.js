...
function addSomeNums(number1, number2) {
  answer = number1 + number2;
  console.log(answer);
  return answer;
}

function subtractSomeNums(number1, number2) {
  answer = number1 - number2;
  console.log(answer);
  return answer;
}

function multiplySomeNums(number1, number2) {
  answer = number1 * number2;
  console.log(answer);
  return answer;
}

function divideSomeNums(number1, number2) {
  answer = number1 / number2;
  console.log(answer);
  return answer;
}
